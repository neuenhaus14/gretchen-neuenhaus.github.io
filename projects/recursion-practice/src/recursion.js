...
var createArray = function(str){
    ...
    var firstLetter = str[0] // first letter
   
    var otherLetters = createArray(str.slice(1)) // rest of letters
       
    var firstLetterArray = firstLetter.split("")
    

    return firstLetterArray.concat(otherLetters);
